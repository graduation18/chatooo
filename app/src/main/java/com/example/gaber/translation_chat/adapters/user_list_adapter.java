...
public class user_list_adapter extends RecyclerView.Adapter<user_list_adapter.MyViewHolder> {

private Context context;
private List<user_data_model> datalist;
    ...
    public user_list_adapter(Context context, List<user_data_model> datalist) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        user_data_model data = datalist.get(position);
